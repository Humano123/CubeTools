let codigoFonteCubeTools = ` @echo off
...
if (window.location.href.includes('?codigoFonte')) {
    console.log(codigoFonteCubeTools);
}

if (window.location.href.includes('?remove')) {
    document.getElementById("coisinhaemcima").style.display = "none";
}